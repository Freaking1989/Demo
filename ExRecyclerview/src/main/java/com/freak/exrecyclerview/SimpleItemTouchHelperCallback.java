package com.freak.exrecyclerview;
...
public class SimpleItemTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    private ExRecyclerView mXrecyclerView;

    public SimpleItemTouchHelperCallback(ItemTouchHelperAdapter adapter, ExRecyclerView recyclerView) {
        mAdapter = adapter;
